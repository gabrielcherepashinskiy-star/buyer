      ...
      <div className="container">
        <div className="page-head">
          ...
          <div className="actions">
            <a className="btn ghost" href={`/purchases/export${q ? `?q=${encodeURIComponent(q)}` : ""}`}>
              Export CSV
            </a>
            <Link className="btn" to="/buy">
              + New Purchase
            </Link>
          </div>
        </div>
        ...
        <Form method="get" className="search-bar">
          ...
          {q ? (
            <Link className="btn ghost" to="/purchases">
              Clear
            </Link>
          ) : null}
        </Form>
        ...
        {purchases.length === 0 ? (
          <div className="card">
            <div className="empty">
              ...
              <Link to="/buy" style={{ color: "var(--violet-2)" }}>
                Record one →
              </Link>
            </div>
          </div>
